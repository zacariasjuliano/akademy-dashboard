...
**Version:** 1.1.x  
**Module:** Akademy Dashboard - SAGE Edu v1.2  
...
The **Akademy Module Base (Dashboard)** is a complementary module responsible for **centralizing the functionalities** of all **Akademy** modules, offering a simple and practical menu for **Pedagogical Management**, **Administrative and Human Resources Management**, **Financial and Accounting Management**, and **Administration**, in addition to other resources of SAGE Edu.
...
- Provide **role-based dashboards** for students, teachers, administrators, and managers,
- Centralize **key information at a glance**, such as tasks, alerts, and academic statistics.

It is essential for **all users of SAGE Education**, ensuring a seamless and productive experience.


### ✨ Main Features

#### 🗂️ Menu & Navigation
- Main menu creation for the platform
- Role-based visibility of menu items
- Quick access to frequently used modules

#### 📊 User Dashboards
- Personalized dashboards for each user type
- Display of key metrics, notifications, and tasks
- Integration with academic and administrative data from other modules
